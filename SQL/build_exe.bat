@echo off
chcp 65001 >nul
title Build SQL Config Tool to EXE

echo ============================================================
echo    BUILD SQL CONFIG TOOL TO EXE
echo ============================================================
echo.
...
"%PYTHON_CMD%" -m PyInstaller --clean --noconfirm sql_config_tool.spec
...
echo ============================================================
echo.
echo File EXE: dist\sql_config_tool.exe
echo.
