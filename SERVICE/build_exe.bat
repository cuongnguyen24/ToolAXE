@echo off
chcp 65001 >nul
title Build Service Config Tool to EXE

echo ============================================================
echo    BUILD SERVICE CONFIG TOOL TO EXE
echo ============================================================
echo.
...
"%PYTHON_CMD%" -m PyInstaller --clean --noconfirm service_config_tool.spec
...
echo ============================================================
echo.
echo File EXE: dist\service_config_tool.exe
echo.
