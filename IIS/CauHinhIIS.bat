@echo off
chcp 65001 >nul
title Cau hinh IIS tu Excel

echo ============================================================
echo    TOOL CAU HINH IIS TU FILE EXCEL
echo ============================================================
echo.
...
cd /d "%SCRIPT_DIR%"
python iis_config_tool.py "%EXCEL_FILE%" --sheet "%SHEET_NAME%"
