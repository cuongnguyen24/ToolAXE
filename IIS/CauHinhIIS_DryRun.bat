@echo off
chcp 65001 >nul
title Cau hinh IIS tu Excel (Dry Run)

echo ============================================================
echo    TOOL CAU HINH IIS TU FILE EXCEL (DRY RUN)
echo ============================================================
echo.
...
set "SHEET_NAME=Cài đặt IIS"
set "EXE_FILE=%SCRIPT_DIR%dist\iis_config_tool.exe"
...
cd /d "%SCRIPT_DIR%"
python iis_config_tool.py "%EXCEL_FILE%" --sheet "%SHEET_NAME%" --dry-run
...
echo ============================================================
echo.
echo De thuc thi cau hinh, chay file: CauHinhIIS.bat
echo.
